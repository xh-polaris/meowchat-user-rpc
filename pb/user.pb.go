...
var file_user_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xa8, 0x01,
	0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x2e, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65,
...
var file_user_proto_depIdxs = []int32{
	...
	1, // 3: user.user.GetUser:input_type -> user.GetUserReq
	3, // 4: user.user.UpdateUser:input_type -> user.UpdateUserReq
	5, // 5: user.user.SearchUser:input_type -> user.SearchUserReq
	2, // 6: user.user.GetUser:output_type -> user.GetUserResp
	4, // 7: user.user.UpdateUser:output_type -> user.UpdateUserResp
	6, // 8: user.user.SearchUser:output_type -> user.SearchUserResp
